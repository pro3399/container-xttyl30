...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-xttyl30.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-xttyl30.containers.anotherwebservice.com/
...
```
git clone git@github.com:pro3399/container-xttyl30.git
cd container-xttyl30
```
...
```
docker attach container-xttyl30
```
